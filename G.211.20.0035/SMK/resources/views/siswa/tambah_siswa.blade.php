    ...
    <main>
        ...
        <div class="form-container ">
            <form action="{{ url('siswa/save') }}" method="post" accept-charset="utf-8">
                ...
                Nama : <input type="text" name="Nama" value="{{ old('Nama') }}" size='50' maxlength='150' />
                ...
                <br /><br />Tanggal Lahir : <input type="date" name="Tanggal_lahir" value="" />
                <br /><br />Tempat Lahir : <input type="text" name="Tempat_lahir" value="{{ old('Tempat_lahir') }}" size='50' maxlength='150' />
                ...
                <br /><br />Nis : <input type="number" name="Nis" value="{{ old('Nis') }}" size='50' maxlength='150' />
